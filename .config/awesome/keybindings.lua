...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ "Mod1", "Shift" }, "Tab", awful.tag.viewprev,
        { description = "view previous", group = "tag" }),
    ...
    end, { description = "focus by direction left", group = "navigation" }),
    awful.key({ modkey, }, "t", function()
        awful.client.focus.global_bydirection("down")
        if client.focus then client.focus:raise() end
    end, { description = "focus by direction down", group = "navigation" }),
    awful.key({ modkey, }, "n", function()
        awful.client.focus.global_bydirection("up")
        if client.focus then client.focus:raise() end
    end, { description = "focus by direction up", group = "navigation" }),
    awful.key({ modkey, }, "s", function()
        awful.client.focus.global_bydirection("right")
        if client.focus then client.focus:raise() end
    end, { description = "focus by direction right", group = "navigation" }),
    ...
    awful.key({ modkey, "Shift" }, "h", function(c)
        ...
        if client.focus then client.focus:raise() end
    end, { description = "swap by direction left", group = "navigation" }),
    awful.key({ modkey, "Shift" }, "t", function(c)
        awful.client.swap.global_bydirection("down")
        if client.focus then client.focus:raise() end
    end, { description = "swap by direction down", group = "navigation" }),
    awful.key({ modkey, "Shift" }, "n", function(c)
        awful.client.swap.global_bydirection("up")
        if client.focus then client.focus:raise() end
    end, { description = "swap by direction up", group = "navigation" }),
    awful.key({ modkey, "Shift" }, "s", function(c)
        awful.client.swap.global_bydirection("right")
        if client.focus then client.focus:raise() end
    end, { description = "swap by direction right", group = "navigation" }),
    ...
    awful.key({ modkey, }, "x", function() awful.spawn("archlinux-logout") end,
        { description = "archlinux logout", group = "system" }),
    ...
    awful.key({}, "XF86AudioRaiseVolume", function()
            awful.spawn("wpctl set-volume @DEFAULT_SINK@ 0.05+")
        end,
    ...
    awful.key({}, "XF86AudioPlay", function()
        ...
        { description = "media play pause", group = "system" }),
    awful.key({}, "XF86AudioNext", function()
            awful.spawn("playerctl next")
        end,
        { description = "media next", group = "system" }),
    awful.key({}, "XF86AudioPrev", function()
            awful.spawn("playerctl previous")
        end,
        { description = "media previous", group = "system" }),
    awful.key({}, "XF86AudioStop", function()
            awful.spawn("playerctl stop")
        end,
        { description = "media stop", group = "system" }),
    ...
    awful.key({}, "Print", function()
        ...
        { description = "printscreen", group = "system" }),
