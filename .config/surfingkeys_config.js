...
//-- Navigation remaps
/* Show hints */
Hints.setCharacters("arstneiowfuydhvk");
Hints.style('font-size: 10pt;');

mapkey('ot', '#8Open an URL in current tab', function () {
...
// Search for a crate in docs.rs
addSearchAlias('c', 'docs rs', 'https://docs.rs/releases/search?query=', 's', 'https://docs.rs/releases/search?query=', function (response) {
...
settings.theme = `
  ...
  body {
    ...
    font-family: "Roboto", "JetBrains Mono NL", "Cascadia Code", "Helvetica Neue", Helvetica, Arial, sans-serif;
    font-size: 12px;
  }
  #sk_omnibar {
    overflow: hidden;
  ...
  kbd {
    ...
    display: inline-block;
    padding: 3px 5px;
    font: 11px "Roboto" "JetBrains Mono NL", "Cascadia Code", "Helvetica Neue", Helvetica, Arial, sans-serif;
    line-height: 10px;
    vertical-align: middle;
